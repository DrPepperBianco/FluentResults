...
/// <summary>
/// Factory for <see cref="IResult"/> and <see cref="IResult{TValue}"/> objects.
/// </summary>
public partial class Result
{
    ...
    /// <summary>
    /// Creates an empty <see cref="IResult"/>
    /// </summary>
    ...
    public static IResult Ok() => Create();
    ...
    /// </summary>
    public static IResult Fail(string errorMessage)
    {
        var result = Create();
    ...
    /// </summary>
    public static IResult Fail(IEnumerable<string> errorMessages)
    {
    ...
    /// </summary>
    public static IResult Merge(params IResult[] results)
    {
    ...
    /// </summary>
    public static IResult OkIf(bool isSuccess, IError error)
    {
    ...
    /// Create a success/failed result depending on the parameter isSuccess
    /// </summary>
    public static IResult OkIf(bool isSuccess, string error)
    {
        return isSuccess ? Ok() : Fail(error);
    }
    ...
    /// </remarks>
    public static IResult OkIf(bool isSuccess, Func<IError> errorFactory)
    {
    ...
    /// Error is lazily evaluated.
    /// </remarks>
    public static IResult OkIf(bool isSuccess, Func<string> errorMessageFactory)
    {
    ...
    /// </summary>
    public static IResult FailIf(bool isFailure, IError error)
    {
    ...
    /// Create a success/failed result depending on the parameter isFailure
    /// </summary>
    public static IResult FailIf(bool isFailure, string error)
    {
        return isFailure ? Fail(error) : Ok();
    }
    ...
    /// Error is lazily evaluated.
    /// </remarks>
    public static IResult FailIf(bool isFailure, Func<IError> errorFactory)
    {
    ...
    /// Error is lazily evaluated.
    /// </remarks>
    public static IResult FailIf(bool isFailure, Func<string> errorMessageFactory)
    {
    ...
    /// </summary>
    public static IResult Try(Action action, Func<Exception, IError> catchHandler = null)
    {
    ...
    /// Executes the action. If an exception is thrown within the action then this exception is transformed via the catchHandler to an Error object
    /// </summary>
    public static async Task<IResult> Try(Func<Task> action, Func<Exception, IError> catchHandler = null)
    {
        catchHandler = catchHandler ?? Settings.DefaultTryCatchHandler;
    ...
    /// Executes the action. If an exception is thrown within the action then this exception is transformed via the catchHandler to an Error object
    /// </summary>
    public static async ValueTask<IResult> Try(Func<ValueTask> action, Func<Exception, IError> catchHandler = null)
    {
        catchHandler = catchHandler ?? Settings.DefaultTryCatchHandler;
    ...
    /// Executes the action. If an exception is thrown within the action then this exception is transformed via the catchHandler to an Error object
    /// </summary>
    public static IResult Try(Func<IResult> action, Func<Exception, IError> catchHandler = null)
    {
        catchHandler = catchHandler ?? Settings.DefaultTryCatchHandler;
    ...
    /// Executes the action. If an exception is thrown within the action then this exception is transformed via the catchHandler to an Error object
    /// </summary>
    public static async Task<IResult> Try(Func<Task<IResult>> action, Func<Exception, IError> catchHandler = null)
    {
        catchHandler = catchHandler ?? Settings.DefaultTryCatchHandler;
    ...
    /// Executes the action. If an exception is thrown within the action then this exception is transformed via the catchHandler to an Error object
    /// </summary>
    public static async ValueTask<IResult> Try(Func<ValueTask<IResult>> action, Func<Exception, IError> catchHandler = null)
    {
        catchHandler = catchHandler ?? Settings.DefaultTryCatchHandler;
